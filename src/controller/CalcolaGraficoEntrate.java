...
@WebServlet("/richiestaCalcolaGraficoEntrate")
public class CalcolaGraficoEntrate extends HttpServlet {
		
	private Connessione connessione=null;
	private Connection con=null;
	private ResultSet rs=null;
	private String queryDate="select * from entrate";
		...
		if(con!=null) {
			try {
				...
				while(rs.next()) {
					...
					jsonIm.put("tipo_entrata",rs.getString(2));
					jsonIm.put("data",rs.getString(3));
					jsonIm.put("valore",rs.getFloat(4));
					jsonArray.put("entrate"+i, jsonIm);
					i++;
				}
